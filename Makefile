DOCKER       = docker
HUGO_VERSION = 0.83.1
DOCKER_IMAGE = sre-hugo-universal
...
build-sre:            ## (via docker) Build hugo site (prod) - used to output docs that work in discover github pages
	 rm -rf docs && docker-compose run --rm build-sre
